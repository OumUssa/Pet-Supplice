...
const Footer = () => {
  return (
    <footer className="mt-auto text-white bg-[linear-gradient(135deg,#0f172a_0%,#134e4a_60%,#064e3b_100%)]">
      <div className="max-w-7xl mx-auto px-4 md:px-6 py-12">
        ...
        <div className="border-t border-emerald-100/30 mt-8 pt-6 text-center text-emerald-50/80">
